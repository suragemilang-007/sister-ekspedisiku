document.addEventListener("DOMContentLoaded", function () {
    ...
    function refreshDashboardData() {
        axios
            .get("/kurir/dashboard-data")
            .then(function (response) {
                const data = response.data;

                // Update statistik
                document.getElementById("total-tugas").textContent =
                    data.stats.total_tugas || 0;
                document.getElementById("sedang-dikirim").textContent =
                    data.stats.sedang_dikirim || 0;
                document.getElementById("selesai").textContent =
                    data.stats.selesai || 0;
                document.getElementById("dibatalkan").textContent =
