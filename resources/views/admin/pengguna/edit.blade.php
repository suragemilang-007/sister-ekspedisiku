                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nama" class="form-control" id="nama"
                                            placeholder="Nama" value="{{ $pengguna->nama }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="email" name="email" class="form-control" id="email"
                                            placeholder="Email" value="{{ $pengguna->email }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="tel" name="nohp" class="form-control" id="nohp"
                                            placeholder="No HP" value="{{ $pengguna->nohp }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <select name="kelamin" class="form-select" id="kelamin" required>
                                            <option value="L" {{ $pengguna->kelamin == 'L' ? 'selected' : '' }}>
                                                Laki-laki</option>
                                            <option value="P" {{ $pengguna->kelamin == 'P' ? 'selected' : '' }}>
                                                Perempuan</option>
                                        </select>
