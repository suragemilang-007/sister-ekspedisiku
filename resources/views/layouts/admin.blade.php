...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="sidebar-nav">
            ...
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a href="/admin/edit" class="nav-link {{ Request::is('admin/edit*') ? 'active' : '' }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Pengaturan Akun">
        ...
        <div class="sidebar-footer d-flex align-items-center justify-content-between px-3 py-2">
            <div class="user-profile d-flex align-items-center">
                ...
                <div class="user-info">
                    ...
                    <div class="user-role" style="font-size: 0.85rem;">Admin</div>
                </div>
                <div>
