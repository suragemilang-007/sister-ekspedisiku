...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="sidebar-nav">
            <div class="nav-section-title">Menu Kurir</div>
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a href="/kurir/tugas" class="nav-link {{ Request::is('kurir/tugas*') ? 'active' : '' }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Tugas Pengiriman">
                        <i class="fas fa-box"></i>
                        <span class="nav-text">Tugas Pengiriman</span>
                    </a>
                </li>
                <li class="nav-item">
        ...
        <div class="sidebar-footer d-flex align-items-center justify-content-between px-3 py-2">
            <div class="user-profile d-flex align-items-center">
                ...
                <div class="user-info">
                    ...
                    <div class="user-role" style="font-size: 0.85rem;">Kurir</div>
                </div>
                <div>
