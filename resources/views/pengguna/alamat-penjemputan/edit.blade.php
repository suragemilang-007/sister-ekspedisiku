...
<div class="container mt-5">
    <div class="card shadow p-4 rounded-4">
        ...
        <form id="editForm">
            ...
            <a href="{{ route('alamat-penjemputan.index') }}" class="btn btn-secondary">Kembali</a>
        </form>
    </div>
</div>
@endsection
            ...
            axios.post("{{ route('alamat-penjemputan.update', $data->id_alamat_penjemputan) }}", formData)
                .then(() => {
                    Swal.fire({
                        icon: 'success',
                        title: 'Berhasil!',
                        text: 'Alamat penjemputan berhasil diperbarui.',
                        timer: 2000,
                        showConfirmButton: false
                    }).then(() => window.location.href = "{{ route('alamat-penjemputan.index') }}");
                })
                .catch(() => {
