...
@section('title', 'Daftar Alamat Penjemputan')
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 mb-0 text-gray-800">Daftar Alamat Penjemputan</h1>
                    <p class="text-muted">Kelola alamat penjemputan Anda</p>
                </div>
            ...
            <div class="card shadow">
                <div class="card-header bg-white py-3">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <span class="badge bg-info">{{ $alamatPenjemputan->count() }} Alamat</span>
                        </div>
                    </div>
                </div>
                
                <div class="card-body">
                    @if($alamatPenjemputan->count() > 0)
                        <!-- Desktop View -->
                        <div class="table-responsive d-none d-md-block">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    @foreach($alamatPenjemputan as $index => $alamat)
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
                                            <td>
                    ...
                    @else
                        ...
                        <div class="text-center py-5">
                            ...
                            <h5 class="text-gray-600 mb-3">Belum Ada Alamat Penjemputan</h5>
                            <p class="text-muted mb-4">
                                Anda belum memiliki alamat penjemputan tersimpan.<br>
                                Tambahkan alamat penjemputan untuk memudahkan pengiriman paket.
                            </p>
                            <a href="{{ route('alamat-penjemputan.create') }}" class="btn btn-primary">
...
<script>
    function confirmDelete(id) {
        ...
        if (result.isConfirmed) {
            axios.delete(`/alamat-penjemputan/delete/${id}`)
                .then(() => {
