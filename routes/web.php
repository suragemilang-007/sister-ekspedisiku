...
Route::prefix('dashboard')->group(function () {
    ...
    // Pembayaran
    Route::get('/payment/{id}', [penggunaController::class, 'payment'])->name('dashboard.payment');
    Route::post('/payment/{id}', [penggunaController::class, 'processPayment'])->name('dashboard.process.payment');
    ...
    // Notifikasi
    Route::get('/notifications', [penggunaController::class, 'notifications'])->name('dashboard.notifications');
